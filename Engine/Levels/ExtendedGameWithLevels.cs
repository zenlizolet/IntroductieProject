...
namespace Engine
{
    ...
    public abstract class ExtendedGameWithLevels : ExtendedGame
    {
        ...
        public static string StateName_HelpState = "help";
        public static string StateName_LevelMenu = "levelselect";
        ...
        public static string StateName_LevelMenuState { get; set; }
